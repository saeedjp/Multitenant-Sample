...
{
    [Route("tenant1/[controller]")]
    [ApiController]
    public class Tenant1Controller : ControllerBase
    {
        private readonly MultiTenantDbContext _context;

        public Tenant1Controller(MultiTenantDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var tenant = await _context.Tenants.SingleOrDefaultAsync(x => x.Subdomain == "tenant1");
            return Ok($"Data for subdomain {tenant.Subdomain} (Tenant 1)");
        }
    }
}
